...
export default class GameMaster {
  ...
  encode() {
    return (
      POGOProtos.Networking.Responses.DownloadItemTemplatesResponse.encode(this.decode)
  ...
  parse() {
    ...
    try {
      ...
      master = POGOProtos.Networking.Responses.DownloadItemTemplatesResponse.decode(data);
